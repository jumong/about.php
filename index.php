...
function game($a, $b, $c){ //Функция: Алгоритм игры
     if ( count($_GET) > false ){ // Проверяем получено ли значение
		 ...
		 //Также можно использовать elseif без пробела но мне так удобнее более читабельно
		 //но только нельзя использовать else if(условие): иначе будет фатальная ошибка, то есть просто не скомпилируется 
     ...
     <body>
         <div>
             ...
             <form method="GET" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                 <input type="text" value="<?= @$_GET['b']/*вывод числа которое было введено ранее*/ ?>" name="b"/><br /><br />
