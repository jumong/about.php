...
function game($a, $b){ //Алгоритм игры
     if ( count($_GET) > 0 ){ // Проверяем получено ли значение
	     if ($b > $a){ // Условие проверяющее введенное значение пользователя, больше задуманного числа или нет
		     echo '<p>Много</p><p>Попробуй еще разочек</p>'; // если да то выводим сообщение "Много" и Просим повторить попытку
	     }
		     ...
		     if($b < $a){ // Проверяем значение пользователя, меньше задуманного числа или нет
			     echo '<p>Мало</p><p>Попробуй еще разочек</p>'; //если да то выводим сообщение "Мало"  и Просим повторить попытку
		     }
			 ...
			 echo '<p>Пожалуйста введите число от 1 до 10</p>';
		 }
     }
}
?>
